...
//    Recebe o tratador de exceções do JSF através da atribuição do construtor da classe
    ...
    public void handle() {
        ...
        while (eventos.hasNext()) {
            ...
            GenericException genericException = getGenericException(excecao);
            ...
            try {
                ...
                if (excecao instanceof ViewExpiredException) {
                    ...
                    FacesUtil.errorMessage(genericException.getMessage());//Exibindo a mensagem lançada pela exceção
                } else {
                    handled = true;
    ...
    private GenericException getGenericException(Throwable exception) {
        if (exception instanceof GenericException) {
            return (GenericException) exception;
        } else if (exception.getCause() != null) {
            return getGenericException(exception.getCause());
        }
        return null;
    }
